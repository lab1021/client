    ...
    public partial class DockContentSample : WeifenLuo .WinFormsUI .Docking .DockContent 
    {
        ...
        {           
            if (e.Control && e.KeyCode == Keys.Right)
            {
                ...
                int secondlastchar = rtbDst.Find("|", 0, lastchar - 1, RichTextBoxFinds.Reverse);
            ...
            if (e.Control && e.KeyCode == Keys.Left)
            {
                int indexstart = rtbDst.SelectionStart;
                int firstchar = rtbDst.Find("|");
                int secondchar=rtbDst .Find ("|",firstchar +1,RichTextBoxFinds .None);
                int lastchar = rtbDst.Find("|", RichTextBoxFinds.Reverse);
                if (indexstart > secondchar)
                {
                    //int nextchar = rtbDst.Find("|",0, indexstart - 1, RichTextBoxFinds.Reverse);
                    //nextchar = rtbDst.Find("|", 0,nextchar - 1, RichTextBoxFinds.Reverse);
                    //rtbDst.SelectionStart = nextchar+1;
                    ...
                    nextchar = rtbDst.Find("|", 0, nextchar - 1, RichTextBoxFinds.Reverse);
                    rtbDst.SelectionLength = 0;
                    rtbDst.SelectionStart = nextchar + 3;
